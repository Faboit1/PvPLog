...
/** Players who existed before FRIEND_ALERTS / PARTY_INVITES get them switched on (their default), nothing else. */
class SettingsMigrationTest {
    ...
    void newDefaultOnSettingsAreBackfilled() {
        ...
        try {
            ...
            assertEquals(old | Setting.FRIEND_ALERTS.mask() | Setting.PARTY_INVITES.mask(), settings);
